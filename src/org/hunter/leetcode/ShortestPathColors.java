            ...
            for (int r = 0; r < red_edges.length; ++r) {
                ...
                for (int rr = 0; rr < red.length; ++rr) {
                    if (red[rr][red_edges[r][0]][0] > 0 && red[rr][red_edges[r][0]][1] == 1) {
                    		if (red[red_edges[r][0]][red_edges[r][1]][0] == 0 || red[red_edges[r][0]][red_edges[r][1]][0] > red[rr][red_edges[r][0]][0] + 1) {
						...
						else if (results[red_edges[r][1]] == 0) {							
							results[red_edges[r][1]] = red[red_edges[r][0]][red_edges[r][1]][0];	
						}
                    }
                }
            ...
            for (int b = 0; b < blue_edges.length; ++b) {
                for (int r = 0; r < red.length; ++r) {
                    if (red[r][blue_edges[b][0]][0] > 0 && red[r][blue_edges[b][0]][1] == 0) {                    	
                    		if (red[blue_edges[b][0]][blue_edges[b][1]][0] == 0 || red[blue_edges[b][0]][blue_edges[b][1]][0] > red[r][blue_edges[b][0]][0] + 1) {
        						red[blue_edges[b][0]][blue_edges[b][1]][0] = red[r][blue_edges[b][0]][0] + 1;
        						red[blue_edges[b][0]][blue_edges[b][1]][1] = 1;
                    		}

						if (results[blue_edges[b][1]] > 0 && results[blue_edges[b][1]] > red[blue_edges[b][0]][blue_edges[b][1]][0]) {
							results[blue_edges[b][1]] = red[blue_edges[b][0]][blue_edges[b][1]][0];	
						}
						else if (results[blue_edges[b][1]] == 0) {
							results[blue_edges[b][1]] = red[blue_edges[b][0]][blue_edges[b][1]][0];
						}
                    }
                }
...
//                    		}
                    		...
                    		if (blue[blue_edges[b][0]][blue_edges[b][1]][0] == 0 || blue[blue_edges[b][0]][blue_edges[b][1]][0] > blue[bb][blue_edges[b][0]][0] + 1) {
        						blue[blue_edges[b][0]][blue_edges[b][1]][0] = blue[bb][blue_edges[b][0]][0] + 1;
        						blue[blue_edges[b][0]][blue_edges[b][1]][1] = 1;
                    		}
						
						if (results[blue_edges[b][1]] > 0 && results[blue_edges[b][1]] > blue[blue_edges[b][0]][blue_edges[b][1]][0]) {
...
//						}
						...
						if (blue[red_edges[r][0]][red_edges[r][1]][0] == 0 || blue[red_edges[r][0]][red_edges[r][1]][0] > blue[b][red_edges[r][0]][0] + 1) {
