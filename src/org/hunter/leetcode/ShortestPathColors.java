...
//        };
    ...
    public int getHopsFromRed(int [] edge, int [][] blue_edges, int [][] red_edges, int hops, int n) {
        ...
        if (redStart == 0) {
            ...
            for (int b = 0; b < blue_edges.length; ++b) {
                if (blue_edges[b][1] == redStart) {
                    ...
                    int tmpResult = getHopsFromBlue(blue_edges[b], blue_edges, red_edges, hops + 1, n);
    ...
    public int getHopsFromBlue(int [] edge, int [][] blue_edges, int [][] red_edges, int hops, int n) {
        ...
        if (blueStart == 0) {
            ...
            for (int r = 0; r < red_edges.length; ++r) {
                if (red_edges[r][1] == blueStart) {
                    ...
                    int tmpResult = getHopsFromRed(red_edges[r], blue_edges, red_edges, hops + 1, n);
    ...
    public int[] shortestAlternatingPaths(int n, int[][] red_edges, int[][] blue_edges) {
        ...
        for (int to = 0; to < n; ++to) {
            if (to == 0) {
                ...
                for (int r = 0; r < red_edges.length; ++r) {
                    if (to == red_edges[r][1]) {
                        int hops = getHopsFromRed(red_edges[r], blue_edges, red_edges, 1, n);
                        if (hops > 0) {
                            if (result[to] > 0) {
                ...
                for (int b = 0; b < blue_edges.length; ++b) {
                    if (to == blue_edges[b][1]) {
                        int hops = getHopsFromBlue(blue_edges[b], blue_edges, red_edges, 1, n);
                        if (hops > 0) {
                            if (result[to] > 0) {
                                result[to] = Math.min(result[to], hops);
                            }
